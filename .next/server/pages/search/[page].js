            ...
            function v() {
              let [e, t] = (0, n.useState)(!1),
                ...
                { isStandartTheme: v, changeTheme: b } = (0, h.F)(),
                {
                  ...
                  error: f,
                  isFetching: S,
                } = (0, p.f5)({ searchItem: x ?? '', currentPage: m });
              return e || f
                ? s.jsx('div', {
          ...
          try {
            ...
            function _(e) {
              let { onItemClick: t, hideDetails: a, serversideData: r } = e,
                ...
                x = (0, h.useSelector)((e) => e.isLoading.isLoading);
              if (!r || x)
                return s.jsx('div', {
        ...
        a.a(e, async (e, r) => {
          try {
            ...
            let h = function ({ Component: e, ...t }) {
              let { store: a, props: r } = n.Y.useWrappedStore(t);
        ...
        a.a(e, async (e, r) => {
          try {
            ...
            let c = async () => {
                try {
                  return {
                    paths: Array.from({ length: 100 }, (e, t) => ({
              ...
              l = async (e) => {
                ...
                try {
                  let e = await fetch(
                    `https://stapi.co/api/v2/rest/astronomicalObject/search?pageSize=10&pageNumber=${Number(t) - 1}`,
                  );
                  if (!e.ok)
                    throw Error(`Failed to fetch data: ${e.statusText}`);
                  return { props: { serversideData: await e.json() } };
                } catch (e) {
                  return (
