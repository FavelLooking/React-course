(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [669],
  {
    ...
    2565: function (e, t, a) {
      ...
      var L = a(2711);
      function U(e) {
        let { onItemClick: t, hideDetails: a, serversideData: s } = e,
          { clicked: c, setClicked: l } = M(),
          { isStandartTheme: r } = v(),
          o = (0, i.v9)((e) => e.isLoading.isLoading);
        if (!s || o)
          return (0, n.jsx)('div', {
            className: ''
              .concat(C().main, ' ')
              .concat(r ? '' : C().alternative, ' '),
            children: (0, n.jsx)(L.a, {}),
          });
        let u = (e) => {
            l(!0), t(e);
          },
          { astronomicalObjects: d } = s;
        return (0, n.jsx)('div', {
          className: c
            ? ''
                .concat(C().main, ' ')
                ...
                .concat(C()['card-small'], ' ')
                .concat(r ? '' : C().alternative)
            : ''.concat(C().main, ' ').concat(r ? '' : C().alternative, ' '),
          onClick: () => {
            c && (l(!1), a());
          },
          children:
      ...
      var z = (e) => {
          let { serversideData: t } = e,
            a = (0, g.useRouter)(),
            { page: s } = a.query,
            r = (0, i.I0)(),
            u = (0, i.v9)((e) => e.pageSlice.totalPages),
            d = (0, i.v9)((e) => e.currentDetails.currentId),
            _ = (0, i.v9)((e) => e.pageSlice.page);
          l.useEffect(() => {
            if (!s) {
              a.push('/search/1');
              return;
          ...
          let m = () => {
            r((0, K.Hf)('')), a.push('/search/'.concat(_));
          };
          return (0, n.jsxs)('div', {
            className: ''.concat(o().wrapper, ' ').concat(c().className),
            'data-testid': 'app-wrapper',
            children: [
              (0, n.jsx)(q, { children: (0, n.jsx)(N, {}) }),
              (0, n.jsxs)('div', {
                  ...
                  (0, n.jsx)(U, {
                    onItemClick: (e) => {
                      r((0, K.Hf)(e)),
                        a.push(
                          ''
                            .concat(a.asPath.split('&')[0], '&details=')
                            .concat(e),
                        );
                    },
                    hideDetails: m,
        ...
        H = (e) => {
          let { serversideData: t } = e;
          return (0, n.jsx)(z, { serversideData: t });
        };
    },
    4467: function (e) {
